...
function moveQ2(){
  document.querySelector('#question').innerHTML = `<h2>このサイトを作った人は誰ですか？</h2>`;
...
function moveQ3(){
  document.querySelector('#question').innerHTML = `<h2>Githubとかありますか？</h2>`;
...
function changeLuke(){
  ...
  document.querySelector('.characterProfile').innerHTML = `<p><span>街を守る警備組織 [カラクリナイツ] の一員.<br>何事にも全力で情に厚い男.<br>同期のヒロナからは「熱血すぎ」と呆れられがち.<br>今日もカラクリ片手に街の平和を守り抜く！<br><br></span></p><p><span>「平和を乱すのはどこのどいつだ！」</span></p>`;
